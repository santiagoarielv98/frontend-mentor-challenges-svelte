	...
	return (
		<div
			className={clsx(
				...
				types.length === 2
					? `border-b-${types[1]} border-l-${types[0]} border-r-${types[1]} border-t-${types[0]} dark:border-b-${types[1]} dark:border-l-${types[0]} dark:border-r-${types[1]} dark:border-t-${types[0]}`
